...
DEF_HELPER_FLAGS_5(bndldx32, TCG_CALL_NO_WG, i64, env, tl, tl, i64, i64)
DEF_HELPER_FLAGS_5(bndldx64, TCG_CALL_NO_WG, i64, env, tl, tl, i64, i64)
DEF_HELPER_FLAGS_7(bndstx32, TCG_CALL_NO_WG, void, env, tl, tl, i64, i64, i64, i64)
DEF_HELPER_FLAGS_7(bndstx64, TCG_CALL_NO_WG, void, env, tl, tl, i64, i64, i64, i64)
...
DEF_HELPER_4(lsl, tl, env, tl, i64, i64)
DEF_HELPER_4(lar, tl, env, tl, i64, i64)
DEF_HELPER_4(verr, void, env, tl, i64, i64)
DEF_HELPER_4(verw, void, env, tl, i64, i64)
DEF_HELPER_4(lldt, void, env, int, i64, i64)
DEF_HELPER_4(ltr, void, env, int, i64, i64)
DEF_HELPER_5(load_seg, void, env, int, int, i64, i64)
DEF_HELPER_6(ljmp_protected, void, env, int, tl, tl, i64, i64)
DEF_HELPER_5(lcall_real, void, env, int, tl, int, int)
DEF_HELPER_7(lcall_protected, void, env, int, tl, int, tl, i64, i64)
DEF_HELPER_4(iret_real, void, env, int, i64, i64)
DEF_HELPER_5(iret_protected, void, env, int, int, i64, i64)
DEF_HELPER_5(lret_protected, void, env, int, int, i64, i64)
...
DEF_HELPER_5(boundw, void, env, tl, int, i64, i64)
DEF_HELPER_5(boundl, void, env, tl, int, i64, i64)
DEF_HELPER_1(rsm, void, env)
DEF_HELPER_2(into, void, env, int)
DEF_HELPER_4(cmpxchg8b_unlocked, void, env, tl, i64, i64)
DEF_HELPER_4(cmpxchg8b, void, env, tl, i64, i64)
DEF_HELPER_3(ldd, void, env, tl, i64)
DEF_HELPER_1(count_ins, void, env)
#ifdef TARGET_X86_64
DEF_HELPER_4(cmpxchg16b_unlocked, void, env, tl, i64, i64)
DEF_HELPER_4(cmpxchg16b, void, env, tl, i64, i64)
#endif
...
DEF_HELPER_4(check_iob, void, env, i32, i64, i64)
DEF_HELPER_4(check_iow, void, env, i32, i64, i64)
DEF_HELPER_4(check_iol, void, env, i32, i64, i64)
...
DEF_HELPER_4(fldt_ST0, void, env, tl, i64, i64)
...
DEF_HELPER_4(fbld_ST0, void, env, tl, i64, i64)
...
DEF_HELPER_5(fldenv, void, env, tl, int, i64, i64)
DEF_HELPER_3(fsave, void, env, tl, int)
DEF_HELPER_5(frstor, void, env, tl, int, i64, i64)
DEF_HELPER_FLAGS_2(fxsave, TCG_CALL_NO_WG, void, env, tl)
DEF_HELPER_FLAGS_4(fxrstor, TCG_CALL_NO_WG, void, env, tl, i64, i64)
DEF_HELPER_FLAGS_5(xsave, TCG_CALL_NO_WG, void, env, tl, i64, i64, i64)
DEF_HELPER_FLAGS_5(xsaveopt, TCG_CALL_NO_WG, void, env, tl, i64, i64, i64)
DEF_HELPER_FLAGS_5(xrstor, TCG_CALL_NO_WG, void, env, tl, i64, i64, i64)
